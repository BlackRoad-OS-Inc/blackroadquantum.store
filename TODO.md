# TODO — blackroadquantum.store

> Active tasks for BlackRoad Quantum Store

## [RC] Priority 1 — Ship Now

- [ ] [RC] Deploy live website to blackroadquantum.store via Gematria/Caddy
...
- [ ] [RC] Write product landing copy for: Software Licenses, AI Models, Datasets, Support Plans, Prism Seats
